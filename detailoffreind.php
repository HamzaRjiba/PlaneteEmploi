...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="container mt-5">
    <h2 class="mb-4">Affichage des données de la table offreind</h2>
    <?php
        ...
        $totalOffres = $conn->query("SELECT COUNT(*) FROM offreind")->fetch_row()[0];
        $totalPages = ceil($totalOffres / $offresParPage);

        $offset = ($currentPage - 1) * $offresParPage;
        $sql = "SELECT * FROM offreind ORDER BY created_at DESC LIMIT $offresParPage OFFSET $offset";
