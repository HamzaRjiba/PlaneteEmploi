...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "INSERT INTO offreind (nom_contact, nom_entreprise, adresse, province, telephone, courriel, ville, code_postal, nombre_candidats, type_placement, heure, date, message)
